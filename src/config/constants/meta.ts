...
export const DEFAULT_META: PageMeta = {
  title: 'KITASWAP',
  description:
    'The most popular AMM on BSC by user count! Earn TINT through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by KITASWAP), NFTs, and more, on a platform you can trust.',
  image: 'images/home/cake/logo.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for KITASWAP exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for KITASWAP exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for KITASWAP exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/pancake-squad': { basePath: true, title: t('KITASWAP Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('KITASWAP'),
  }
}
