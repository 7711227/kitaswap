...
const MigrationSticky: React.FC<React.PropsWithChildren<MigrationStickyProps>> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and TINT') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned TINT will be harvested to your wallet upon unstake.')
