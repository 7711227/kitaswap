...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 KITASWAP Bunny NFTs at the snapshot may also purchase one additional Pancake Squad NFT in the presale for each Pancake Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of TINT spent on KITASWAP Squad NFTs will be burned as part of our weekly TINT burn.')],
  },
  {
