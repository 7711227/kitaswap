...
const ButtonMenu: React.FC<React.PropsWithChildren<ButtonMenuProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    t(
      'Your chance of winning is proportional to the TINT you deposit relative to the total TINT deposit for Pottery. Currently, there is a cap to the total CAKE deposit size during the beta release.',
    ),
    {
      placement: 'top-end',
      tooltipOffset: [20, 10],
