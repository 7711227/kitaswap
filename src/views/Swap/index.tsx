...
export default function Swap() {
  ...
  return (
    <>
     <div  style={{width:'100%', height:"40px",display:'flex', justifyContent:'center', alignItems:'center', background:"#04121e"}}>
      <a href="/" style={{fontSize:'15px'}}>Swap</a>
      <a href="/" style={{margin:'0px 16px', fontSize:'15px'}}>add Liquidity</a>
      <a href="/" style={{fontSize:'15px'}}>order Limit</a>

      </div>
    <Page  id="bgImg_swap" removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded}>
      ...
      <Flex width="100%" justifyContent="center" position="relative">
        ...
        <Flex flexDirection="column">
          <StyledSwapContainer  $isChartExpanded={isChartExpanded}>
            <StyledInputCurrencyWrapper background="#221a2a" borderRadius="19px"  mt={isChartExpanded ? '24px' : '0'}>
              <AppBody >
